...
export default function Snake() {
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-hidden relative font-sans flex flex-col items-center py-10 selection:bg-neon-blue selection:text-black">
      {/* Background Glows */}
      <div className="absolute top-[-20%] left-[-20%] w-[60%] h-[60%] bg-neon-blue/10 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-20%] w-[60%] h-[60%] bg-neon-purple/10 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="w-full px-6 flex justify-between items-center mb-8 z-10 max-w-5xl">
        ...
        <h1 className="text-3xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-cyan-400 drop-shadow-[0_0_10px_rgba(0,243,255,0.3)] uppercase">
          Neon Snake
        </h1>
        <div className="w-10" />
      </div>
